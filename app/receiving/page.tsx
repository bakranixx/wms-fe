...
export default function ReceivingPage() {
  ...
  const columns: ColumnDef<Receiving>[] = [
    ...
    },
    {
      ...
      header: ({ column }) => <DataTableColumnHeader column={column} title="Receiving Date" />,
    ...
    <DashboardLayout>
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>
            Scan product barcode to quickly find and receive items
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      {pendingPOs.length > 0 && (
        <div className="mb-6">
          <h3 className="mb-3 text-lg font-semibold">Pending Purchase Orders</h3>
                ...
                >
                  <CardContent className="pt-4">
                    ...
                    <div className="mt-3 flex items-center justify-between text-sm text-muted-foreground">
                      ...
                      <span>Expected: {format(po.expectedDate, "MMM dd")}</span>
                    </div>
      ...
      <div>
        <h3 className="mb-3 text-lg font-semibold">Receiving History</h3>
        {receivings.length === 0 ? (
          <EmptyState
